...
public class StructureTutorialMain {
    ...
    public static final String MODID = "trickier_traps";
    ...
    public void biomeModification(final BiomeLoadingEvent event) {
        ...
        if (event.getCategory() == Biome.Category.DESERT) {
            event.getGeneration().getStructures().add(() -> STConfiguredStructures.CONFIGURED_DESERT_PYRAMID);
        }
    }
    ...
    public void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld){
            ...
            tempMap.put(STStructures.DESERT_PYRAMID.get(), DimensionStructuresSettings.field_236191_b_.get(STStructures.DESERT_PYRAMID.get()));
