...
public class STConfiguredStructures {
     ...
     */
    public static StructureFeature<?, ?> CONFIGURED_DESERT_PYRAMID = STStructures.DESERT_PYRAMID.get().func_236391_a_(IFeatureConfig.NO_FEATURE_CONFIG);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(StructureTutorialMain.MODID, "configured_run_down_house"), CONFIGURED_DESERT_PYRAMID);
        ...
        FlatGenerationSettings.STRUCTURES.put(STStructures.DESERT_PYRAMID.get(), CONFIGURED_DESERT_PYRAMID);
    }
}
