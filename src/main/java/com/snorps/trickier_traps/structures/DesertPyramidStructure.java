package com.snorps.trickier_traps.structures;

import com.google.common.collect.ImmutableList;
import com.mojang.serialization.Codec;
import com.snorps.trickier_traps.StructureTutorialMain;
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation(StructureTutorialMain.MODID, "desert_pyramid/desert_pyramid_starter")),
                    ...
                    false); // Place at heightmap (top land). Set this to false for structure to be place at blockpos's y value instead
            ...
            StructureTutorialMain.LOGGER.log(Level.DEBUG, "Desert Pyramid at " + (blockpos.getX()) + " " + blockpos.getY() + " " + (blockpos.getZ()));
        }
